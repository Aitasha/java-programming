...
public class CollectionsUtil {
    public static void main(String[] args) {
        ...
        System.out.println("How many 5? - " + countOfFives);

        int countOfOnes = Collections.frequency(nums, 1);
        System.out.println("How many 1? - " + countOfOnes);

        Collections.replaceAll(nums, 5, 50);
        System.out.println("after replacing 5 with 50 - " + nums);

        Collections.sort(nums, Collections.reverseOrder());
        System.out.println("after reverse sort = " + nums );

        Collections.shuffle(nums);
        System.out.println("After shaffling = " + nums);
